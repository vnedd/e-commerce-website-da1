    ...
    <div class=" flex items-center justify-between md:justify-start h-full mx-auto">
        ...
        <nav class="flex justify-between">
            <ul class="md:flex items-center space-x-4 hidden">
                ...
                <li>
                    <a href="index.php?act=post" class="font-medium text-sm  text-slate-500 hover:text-slate-800 <?php echo isset($_GET['act']) && $_GET['act'] === "post" ? "text-slate-800 font-medium" : "" ?>">Post</a>
                </li>
            </ul>
        </nav>
