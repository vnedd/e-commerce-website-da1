        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4">
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" class="form-input rounded text-slate-900" name="title" id="title" placeholder="Example: wellcome halloween" />
                ...
                <div class="flex flex-col space-y-2">
                    ...
                    <input type="text" class="form-input rounded text-slate-900" name="subtitle" id="subtitle" />
                    <?php echo !empty($error['subtitle']) ? '<span class="text-red-500 text-sm">' . $error['subtitle'] . '</span>' : ""  ?>
                </div>
            </div>
            <button class="btn md:btn-md btn-sm capitalize rounded-full bg-slate-700 hover:bg-slate-900 text-white mt-5" type="submit" name="add_billboard">Add billboard</button>
        </form>
    </div>
</div>
